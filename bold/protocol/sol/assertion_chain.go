...
// Package sol includes an easy-to-use abstraction around the challenge protocol
// contracts using their Go bindings and exposes minimal details of Ethereum's
// internals.
package sol
